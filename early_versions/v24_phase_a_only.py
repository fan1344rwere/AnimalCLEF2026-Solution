...
OUTPUT_DIR = "/root/autodl-tmp/ov24"
...
HDBSCAN_MIN_CLUSTER = {
    "LynxID2025": 8,          # ~77 known individuals, expect more in test
    "SalamanderID2025": 3,    # many singletons, small clusters
    "SeaTurtleID2022": 5,     # moderate clusters
    "TexasHornedLizards": 3,  # small clusters expected, was 5→only 7 clusters
}
HDBSCAN_MIN_SAMPLES = 2  # lowered from 3 for better granularity
...
# Pseudo-labeling
N_PSEUDO_ROUNDS = 0  # DISABLED — V23 proved pseudo-labels destroy Phase A quality
