# AnimalCLEF2026 Solution (ARI=0.24012) - Currently Ranked #2 Among All Open-Source Solutions

> **AnimalCLEF26 @ CVPR & CLEF** | Discovery and Re-Identification of Individual Animals
>
> Leaderboard Score: **0.24012** | Currently the **2nd highest score** among all publicly shared solutions on Kaggle
...
## Best Solution: V21 + V22 Ensemble (ARI=0.24012)
...
| **V21+V22** | **0.24012** | **Foundation ensemble + SupCon projection** | **Best: combine per-species results** |
